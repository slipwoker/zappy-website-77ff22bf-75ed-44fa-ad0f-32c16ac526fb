document.addEventListener('DOMContentLoaded', function () {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isFormValid) {
        ...
        if (firstInvalid) {
          ...
          const position = firstInvalid.getBoundingClientRect().top + window.pageYOffset - offset;
      ...
      setTimeout(function () {
        ...
        contactForm.querySelectorAll('.form-error-message').forEach(function (el) {
  ...
  const animationTargets = document.querySelectorAll(OBSERVED_SELECTORS);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גלאסו מקלחונים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '77ff22bf-75ed-44fa-ad0f-32c16ac526fb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '77ff22bf-75ed-44fa-ad0f-32c16ac526fb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '77ff22bf-75ed-44fa-ad0f-32c16ac526fb';
